...
<div className="tourism-hero-copy absolute inset-x-0 bottom-24 z-10 px-5 sm:bottom-32 sm:px-8 lg:px-10">          <p className="mb-3 inline-flex items-center gap-2 rounded-full border border-white/25 bg-[#092a36]/55 px-3 py-1.5 text-[10px] font-bold uppercase tracking-[0.18em] backdrop-blur-md">
      ...
      <section id="destinations" className="relative isolate scroll-mt-16 overflow-hidden px-5 py-24 sm:px-8 lg:px-10 lg:py-32">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="reveal-on-scroll mb-14 max-w-3xl">
            ...
            <div className="grid grid-flow-dense gap-6 md:grid-cols-2 xl:grid-cols-3">            {destinations.map((destination, index) => (
              <article
